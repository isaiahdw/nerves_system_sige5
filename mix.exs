defmodule NervesSystemSige5.MixProject do
  use Mix.Project

  @github_organization "isaiahdw"
  @app :nerves_system_sige5
  ...
  defp nerves_package do
    [
      ...
      #
      # The RK3576 has 4x Cortex-A72 + 4x Cortex-A53. Both are ARMv8.0-A, so
      # cortex-a72 tuning runs fine on the little cores.
      env: [
        {"TARGET_ARCH", "aarch64"},
